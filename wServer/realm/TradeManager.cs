...
namespace wServer.realm
{
    public class TradeManager
    {
        ...
        [ThreadStatic]
        private static List<KeyValuePair<Player, Player>> _currentTradeRequests = new List<KeyValuePair<Player, Player>>();

        public static List<Player> TradingPlayers { get { return _tradingPlayers; } }
        [ThreadStatic]
        private static List<Player> _tradingPlayers = new List<Player>();
